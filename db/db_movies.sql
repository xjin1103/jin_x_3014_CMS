...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 06, 2018 at 12:23 AM
...
INSERT INTO `tbl_comments` (`comments_id`, `comments_auth`, `comments_copy`, `comments_date`) VALUES
(1, 'some', 'thing', '2018-04-05 12:03:56');
...
(1, 'guardians2.jpg', 'Guardians of the Galaxy Vol. 2', '2017', '2h 16m', 'The Guardians must fight to keep their newfound family together as they unravel the mystery of Peter Quillâ€™s true parentage.', 'Guardians2.mp4', 'May 5, 2017afe'),
...
(22, 'Pacific_Rim_Uprising5.jpg', 'Pacific Rim Uprising', '2018', '2h30m', 'Jake Pentecost is a once-promising Jaeger pilot whose legendary father gave his life to secure humanity\'s victory against the monstrous Kaiju. Jake has since abandoned his training only to become caught up in a criminal underworld. But when an even more unstoppable threat is unleashed to tear through cities and bring the world to its knees, Jake is given one last chance by his estranged sister, Mako Mori, to live up to his father\'s legacy.', 'no', 'March 25, 2018'),
(23, 'raider_poster.jpg', 'Tomb Raider', '2018', '2h', 'Lara Croft is the fiercely independent daughter of an eccentric adventurer who vanished years earlier. Hoping to solve the mystery of her father&#039;s disappearance, Croft embarks on a perilous journey to his last-known destination -- a fabled tomb on a mythical island that might be somewhere off the coast of Japan. The stakes couldn&#039;t be higher as Lara must rely on her sharp mind, blind faith and stubborn spirit to venture into the unknown.', 'no', 'March 7, 2018'),
(24, 'blackpanther.jpg', 'Black Panther', '2018', '2h15m', 'After the death of his father, T&#039;Challa returns home to the African nation of Wakanda to take his rightful place as king. When a powerful enemy suddenly reappears, T&#039;Challa&#039;s mettle as king -- and as Black Panther -- gets tested when he&#039;s drawn into a conflict that puts the fate of Wakanda and the entire world at risk. Faced with treachery and danger, the young king must rally his allies and release the full power of Black Panther to defeat his foes and secure the safety of his people.', 'no', 'January 29, 2018'),
(25, 'ghostbusters.jpg', 'Ghost Busters', '2016', '2h14m', 'Paranormal researcher Abby Yates (Melissa McCarthy) and physicist Erin Gilbert are trying to prove that ghosts exist in modern society. When strange apparitions appear in Manhattan, Gilbert and Yates turn to engineer Jillian Holtzmann for help. Also joining the team is Patty Tolan, a lifelong New Yorker who knows the city inside and out. Armed with proton packs and plenty of attitudes, the four women prepare for an epic battle as more than 1,000 mischievous ghouls descend on Times Square.', 'no', 'July 15, 2016');
...
--
-- Table structure for table `tbl_mov_comm`
--

DROP TABLE IF EXISTS `tbl_mov_comm`;
CREATE TABLE IF NOT EXISTS `tbl_mov_comm` (
  `mov_comm_id` mediumint(9) NOT NULL AUTO_INCREMENT,
  `movies_id` mediumint(9) NOT NULL,
  `comments_id` mediumint(9) NOT NULL,
  PRIMARY KEY (`mov_comm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_mov_comm`
--

INSERT INTO `tbl_mov_comm` (`mov_comm_id`, `movies_id`, `comments_id`) VALUES
(1, 2, 1);
...
(41, 'test', 'test', '$2y$10$.TVFkF64pMEkzVp52bzZSuiclgQnM6hDiDkLenTItgJICmbQBZxk2', 'wyao@alcanada.com', '2018-04-05 01:51:44', '::1', '2', 'unlimited');
COMMIT;
